...
<meta name="format-detection" content="telephone=no" /> // 关闭识别电话号码
<meta content="email=no" name="format-detection" /> // 关闭邮箱识别
<meta name="viewport" content="width=device-width, initial-scale=1"> // Android版Chrome 32+浏览器，如果设置viewport meta的值为width=device-width，这种情况下浏览器会马上出发点击事件，不会延迟300毫秒。
```